...
REPOS = {
    ...
    'p2': [
        ...
        {'name': 'p2team7', 'author': 'Wanqing Zhou,周莞卿, Zihang Song,宋子航, Yangyang Wang,王扬洋, Mingcheng Hu,胡铭程',
         'title': '07 - The Play of Prisoners'},
